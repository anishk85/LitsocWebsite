...
function ClubCard({ title, imageSrc, link }) {
  return (
    <div className="flex flex-col items-center w-[300px] h-[480px] bg-transparent border-white border-[2px] p-4 max-md:w-[250px] max-md:h-[420px]">
      {/* Centered "lit-soc" inside the ellipse */}
      <div className="w-24 h-8 flex items-center justify-center border-2 border-white bg-zinc-100 bg-opacity-10 rounded-full text-white text-sm">
        lit-soc
      </div>
      ...
      <a
        href={link}
        className="mt-8 text-2xl font-medium tracking-tighter text-blue-400 max-md:mt-6 max-md:text-xl text-center underline"
      >
        View More
      </a>
    </div>
